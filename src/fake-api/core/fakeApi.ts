...
export interface IFakeApi<TData extends Record<string, unknown>> {
  ...
  filter: (pagination: FakeApiPagination, filters: FakeApiFilter) => Promise<BackendPaginated<TData>>;
...
export class FakeApi<TData extends FakeApiData> implements IFakeApi<TData> {
  ...
  public filter = async (pagination: FakeApiPagination, filters: FakeApiFilter): Promise<BackendPaginated<TData>> => {
